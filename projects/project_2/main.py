...
if __name__ == "__main__":
    ...
    plot_(img, magnitude_spectrum, img_ifft, ['Imagem original (512, 512 pixels)', 'espectro de Fourier (magnitude)', 'imagem após inversa de Fourier', 'imagem_original'])
    ...
    for i in range(10, 120, 10):
        ...
        #plot_(low_core, high_core, pass_core, )
        ...
        #plot_(low_ifft, high_ifft, pass_ifft, [, 'resultados dos filtros aplicados - raio {}'.format(i)])
    ...
    plot_6(img_comp, title, 'frequency_compression')
